  ...
  return (
    <>
      <div className="border border-gray-500 rounded-xl max-w-3xl w-[80%] m-auto mt-5 ">
        <div className="bg-black dark:bg-blue-50 rounded-t-xl p-3 sm:px-5 w-full h-fit flex justify-between items-center">
          <p className="text-white text-sm sm:text-lg font-semibold dark:text-black">
                  ...
                  return (
                    <TableRow key={id}>
                      ...
                      <TableCell className="text-center flex ">
                        <div className="flex justify-center lg:pl-2 items-center h-full space-x-1">
                          <CiCirclePlus
